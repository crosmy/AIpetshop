...
public class CodeGenerator {
    ...
    private static StrategyConfig strategyConfig() {
        ...
        strategyConfig.setInclude("pet", "post", "user", "transaction", "message");
    ...
    private static DataSourceConfig dataSourceConfig() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/petDB?serverTimezone=UTC");
